...
class TimelineView(QWidget):
    ...
    def setup_ui(self):
        ...
        for d in range(60):
            ...
            for h in range(24):
                ...
                time_str = f"{h:02d}:00" if h % 2 == 0 else ""
    ...
    def update_cur_time_line(self):
        ...
        if not hasattr(self, 'time_line'):
            ...
            self.time_line.setStyleSheet("background-color: #E03E3E; border: none;")
    ...
    def jump_to_today(self):
        ...
        scroll_position = int((target_col - 4) * 40)
    ...
    def update_tasks(self, api_tasks):
        ...
        for i, task in enumerate(api_tasks):
            ...
            color = "#5A4AD1"
            if status == "Completed": color = "#0F7B6C"
            elif status == "In Progress": color = "#D9730D"
