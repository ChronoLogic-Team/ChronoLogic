...
class TaskCard(QFrame):
    ...
    def cycle_status(self):
        ...
        is_done = (next_s == "Done")
        self.status_changed.emit(self.task_id, {"status": next_s, "is_completed": is_done})
...
class ExecutionView(QWidget):
    ...
    def update_tasks(self, api_tasks):
        ...
        if not api_tasks:
            empty = QLabel("Your schedule is clear.")
            empty.setStyleSheet("color: #9CA3AF; font-size: 14px; background: transparent;")
